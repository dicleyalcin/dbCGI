...
def ce10IDQuery(uploaded_file):    	
	...
	with open(resultName, 'w+') as f:
		...
		for pk in range(len(PKs)):
			...
			header.replace("'",'')
			f.write(header+"\n")
			RES = Ce10.objects.raw('SELECT 1 as id , cgid, chrom, cgistart, cgiend, length, pergc, obsexp,type1, genesym1, strand1, refid1,type2, genesym2, strand2, refid2,type3, genesym3, strand3, refid3,type4, genesym4, strand4, refid4,type5, genesym5, strand5, refid5,type6, genesym6, strand6, refid6,type7, genesym7, strand7, refid7,type8, genesym8, strand8, refid8,type9, genesym9, strand9, refid9,type10, genesym10, strand10, refid10,type11, genesym11, strand11, refid11,type12, genesym12, strand12, refid12,type13, genesym13 , strand13, refid13,type14, genesym14 , strand14, refid14,type15, genesym15 , strand15, refid15,type16, genesym16 , strand16, refid16,type17, genesym17 , strand17, refid17,type18, genesym18 , strand18, refid18,type19, genesym19 , strand19, refid19,type20, genesym20 , strand20, refid20,type21, genesym21 , strand21, refid21,type22, genesym22 , strand22, refid22,type23, genesym23 , strand23, refid23,type24, genesym24 , strand24, refid24,type25, genesym25 , strand25, refid25,type26, genesym26 , strand26, refid26 FROM Ce10 WHERE type1!="Intergenic" and refid1 like  \"%%%%%s;%%%%\" or refid2 like  \"%%%%%s;%%%%\" or refid3 like  \"%%%%%s;%%%%\" or refid4 like  \"%%%%%s;%%%%\" or refid5 like  \"%%%%%s;%%%%\" or refid6 like  \"%%%%%s;%%%%\" or refid7 like  \"%%%%%s;%%%%\" or refid8 like  \"%%%%%s;%%%%\" or refid9 like  \"%%%%%s;%%%%\" or refid10 like  \"%%%%%s;%%%%\" or refid11 like  \"%%%%%s;%%%%\" or refid12 like  \"%%%%%s;%%%%\" or refid13 like  \"%%%%%s;%%%%\" or refid14 like  \"%%%%%s;%%%%\" or refid15 like  \"%%%%%s;%%%%\" or refid16 like  \"%%%%%s;%%%%\" or refid17 like  \"%%%%%s;%%%%\" or refid18 like  \"%%%%%s;%%%%\" or refid19 like  \"%%%%%s;%%%%\" or refid20 like  \"%%%%%s;%%%%\" or refid21 like  \"%%%%%s;%%%%\" or refid22 like  \"%%%%%s;%%%%\" or refid23 like  \"%%%%%s;%%%%\" or refid24 like  \"%%%%%s;%%%%\" or refid25 like  \"%%%%%s;%%%%\" or refid26 like  \"%%%%%s;%%%%\"' % (ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID))
			for obj in RES:
...
def hg38IDQuery(uploaded_file):
	...
	with open(resultName, 'w+') as f:
		...
		for pk in range(len(PKs)):
			...
			header.replace("'",'')
			f.write(header+"\n")
			#RES = connection.cursor('SELECT * FROM Hg38 WHERE type1!="Intergenic" and refid1 like  \"%%%%%s;%%%%\" or refid2 like  \"%%%%%s;%%%%\" or refid3 like  \"%%%%%s;%%%%\" or refid4 like  \"%%%%%s;%%%%\" or refid5 like  \"%%%%%s;%%%%\" or refid6 like  \"%%%%%s;%%%%\" or refid7 like  \"%%%%%s;%%%%\" or refid8 like  \"%%%%%s;%%%%\" or refid9 like  \"%%%%%s;%%%%\" or refid10 like  \"%%%%%s;%%%%\" or refid11 like  \"%%%%%s;%%%%\" or refid12 like  \"%%%%%s;%%%%\" or refid13 like  \"%%%%%s;%%%%\"' % (ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID))
			#RES.execute()
			RES = Hg38.objects.raw('SELECT 1 as id , cgid, chrom, cgistart, cgiend, length, pergc, obsexp, type1, geneSym1, refid1, strand1, type2, genesym2, refid2, strand2, type3, genesym3, refid3, strand3, type4, genesym4, refid4, strand4, type5, genesym5, refid5, strand5,type6, genesym6, refid6, strand6, type7, genesym7, refid7, strand7, type8, genesym8, refid8, strand8, type9, genesym9, refid9, strand9, type10, genesym10, refid10, strand10, type11, genesym11, refid11, strand11, type12, genesym12, refid12, strand12, type13, genesym13, refid13, strand13 FROM Hg38 WHERE type1!="Intergenic" and refid1 like  \"%%%%%s;%%%%\" or refid2 like  \"%%%%%s;%%%%\" or refid3 like  \"%%%%%s;%%%%\" or refid4 like  \"%%%%%s;%%%%\" or refid5 like  \"%%%%%s;%%%%\" or refid6 like  \"%%%%%s;%%%%\" or refid7 like  \"%%%%%s;%%%%\" or refid8 like  \"%%%%%s;%%%%\" or refid9 like  \"%%%%%s;%%%%\" or refid10 like  \"%%%%%s;%%%%\" or refid11 like  \"%%%%%s;%%%%\" or refid12 like  \"%%%%%s;%%%%\" or refid13 like  \"%%%%%s;%%%%\"' % (ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID))
			for obj in RES:
				AssoCGI = [obj.cgid, obj.chrom, obj.cgistart, obj.cgiend, obj.pergc, obj.length, obj.obsexp]
				AssoCGI = [str(i) for i in AssoCGI]
				Annot = [[obj.type1, obj.genesym1, obj.strand1, obj.refid1],
...
def mm10IDQuery(uploaded_file):
	...
	with open(resultName, 'w+') as f:
		...
		for pk in range(len(PKs)):
			...
			header.replace("'",'')
			f.write(header+"\n")						
			RES = Mm10.objects.raw('SELECT 1 as id , cgid, chrom, cgistart, cgiend, length, pergc, obsexp,type1, genesym1, strand1, refid1,type2, genesym2, strand2, refid2,type3, genesym3, strand3, refid3,type4, genesym4, strand4, refid4,type5, genesym5, strand5, refid5,type6, genesym6, strand6, refid6,type7, genesym7, strand7, refid7,type8, genesym8, strand8, refid8,type9, genesym9, strand9, refid9,type10, genesym10, strand10, refid10,type11, genesym11, strand11, refid11,type12, genesym12, strand12, refid12,type13, genesym13 , strand13, refid13,type14, genesym14 , strand14, refid14,type15, genesym15 , strand15, refid15,type16, genesym16 , strand16, refid16,type17, genesym17 , strand17, refid17,type18, genesym18 , strand18, refid18,type19, genesym19 , strand19, refid19,type20, genesym20 , strand20, refid20,type21, genesym21 , strand21, refid21,type22, genesym22 , strand22, refid22,type23, genesym23 , strand23, refid23,type24, genesym24 , strand24, refid24,type25, genesym25 , strand25, refid25,type26, genesym26 , strand26, refid26,type27, genesym27 , strand27, refid27,type28, genesym28 , strand28, refid28,type29, genesym29 , strand29, refid29,type30, genesym30 , strand30, refid30,type31, genesym31 , strand31, refid31,type32, genesym32 , strand32, refid32,type33, genesym33 , strand33, refid33,type34, genesym34 , strand34, refid34,type35, genesym35 , strand35, refid35,type36, genesym36 , strand36, refid36,type37, genesym37 , strand37, refid37,type38, genesym38 , strand38, refid38,type39, genesym39 , strand39, refid39,type40, genesym40 , strand40, refid40,type41, genesym41 , strand41, refid41,type42, genesym42 , strand42, refid42,type43, genesym43 , strand43, refid43,type44, genesym44 , strand44, refid44,type45, genesym45 , strand45, refid45,type46, genesym46 , strand46, refid46,type47, genesym47 , strand47, refid47,type48, genesym48 , strand48, refid48,type49, genesym49 , strand49, refid49,type50, genesym50 , strand50, refid50 FROM Mm10 WHERE type1!="Intergenic" and refid1 like  \"%%%%%s;%%%%\" or refid2 like  \"%%%%%s;%%%%\" or refid3 like  \"%%%%%s;%%%%\" or refid4 like  \"%%%%%s;%%%%\" or refid5 like  \"%%%%%s;%%%%\" or refid6 like  \"%%%%%s;%%%%\" or refid7 like  \"%%%%%s;%%%%\" or refid8 like  \"%%%%%s;%%%%\" or refid9 like  \"%%%%%s;%%%%\" or refid10 like  \"%%%%%s;%%%%\" or refid11 like  \"%%%%%s;%%%%\" or refid12 like  \"%%%%%s;%%%%\" or refid13 like  \"%%%%%s;%%%%\" or refid14 like  \"%%%%%s;%%%%\" or refid15 like  \"%%%%%s;%%%%\" or refid16 like  \"%%%%%s;%%%%\" or refid17 like  \"%%%%%s;%%%%\" or refid18 like  \"%%%%%s;%%%%\" or refid19 like  \"%%%%%s;%%%%\" or refid20 like  \"%%%%%s;%%%%\" or refid21 like  \"%%%%%s;%%%%\" or refid22 like  \"%%%%%s;%%%%\" or refid23 like  \"%%%%%s;%%%%\" or refid24 like  \"%%%%%s;%%%%\" or refid25 like  \"%%%%%s;%%%%\" or refid26 like  \"%%%%%s;%%%%\" or refid27 like  \"%%%%%s;%%%%\" or refid28 like  \"%%%%%s;%%%%\" or refid29 like  \"%%%%%s;%%%%\" or refid30 like  \"%%%%%s;%%%%\" or refid31 like  \"%%%%%s;%%%%\" or refid32 like  \"%%%%%s;%%%%\" or refid33 like  \"%%%%%s;%%%%\" or refid34 like  \"%%%%%s;%%%%\" or refid35 like  \"%%%%%s;%%%%\" or refid36 like  \"%%%%%s;%%%%\" or refid37 like  \"%%%%%s;%%%%\" or refid38 like  \"%%%%%s;%%%%\" or refid39 like  \"%%%%%s;%%%%\" or refid40 like  \"%%%%%s;%%%%\" or refid41 like  \"%%%%%s;%%%%\" or refid42 like  \"%%%%%s;%%%%\" or refid43 like  \"%%%%%s;%%%%\" or refid44 like  \"%%%%%s;%%%%\" or refid45 like  \"%%%%%s;%%%%\" or refid46 like  \"%%%%%s;%%%%\" or refid47 like  \"%%%%%s;%%%%\" or refid48 like  \"%%%%%s;%%%%\" or refid49 like  \"%%%%%s;%%%%\" or refid50 like  \"%%%%%s;%%%%\"' % (ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID))
...
def dm3IDQuery(uploaded_file):
	...
	with open(resultName, 'w+') as f:
		...
		for pk in range(len(PKs)):
			...
			RES = Dm3.objects.raw('SELECT 1 as id , cgid, chrom, cgistart, cgiend, length, pergc, obsexp,type1, genesym1, strand1, refid1,type2, genesym2, strand2, refid2,type3, genesym3, strand3, refid3,type4, genesym4, strand4, refid4,type5, genesym5, strand5, refid5,type6, genesym6, strand6, refid6,type7, genesym7, strand7, refid7,type8, genesym8, strand8, refid8,type9, genesym9, strand9, refid9,type10, genesym10, strand10, refid10,type11, genesym11, strand11, refid11,type12, genesym12, strand12, refid12,type13, genesym13 , strand13, refid13,type14, genesym14 , strand14, refid14,type15, genesym15 , strand15, refid15,type16, genesym16 , strand16, refid16,type17, genesym17 , strand17, refid17,type18, genesym18 , strand18, refid18,type19, genesym19 , strand19, refid19,type20, genesym20 , strand20, refid20,type21, genesym21 , strand21, refid21,type22, genesym22 , strand22, refid22,type23, genesym23 , strand23, refid23,type24, genesym24 , strand24, refid24,type25, genesym25 , strand25, refid25,type26, genesym26 , strand26, refid26,type27, genesym27 , strand27, refid27,type28, genesym28 , strand28, refid28,type29, genesym29 , strand29, refid29,type30, genesym30 , strand30, refid30,type31, genesym31 , strand31, refid31,type32, genesym32 , strand32, refid32,type33, genesym33 , strand33, refid33,type34, genesym34 , strand34, refid34,type35, genesym35 , strand35, refid35,type36, genesym36 , strand36, refid36,type37, genesym37 , strand37, refid37,type38, genesym38 , strand38, refid38,type39, genesym39 , strand39, refid39,type40, genesym40 , strand40, refid40,type41, genesym41 , strand41, refid41,type42, genesym42 , strand42, refid42,type43, genesym43 , strand43, refid43,type44, genesym44 , strand44, refid44,type45, genesym45 , strand45, refid45,type46, genesym46 , strand46, refid46,type47, genesym47 , strand47, refid47,type48, genesym48 , strand48, refid48,type49, genesym49 , strand49, refid49,type50, genesym50 , strand50, refid50 FROM Dm3 WHERE type1!="Intergenic" and refid1 like  \"%%%%%s;%%%%\" or refid2 like  \"%%%%%s;%%%%\" or refid3 like  \"%%%%%s;%%%%\" or refid4 like  \"%%%%%s;%%%%\" or refid5 like  \"%%%%%s;%%%%\" or refid6 like  \"%%%%%s;%%%%\" or refid7 like  \"%%%%%s;%%%%\" or refid8 like  \"%%%%%s;%%%%\" or refid9 like  \"%%%%%s;%%%%\" or refid10 like  \"%%%%%s;%%%%\" or refid11 like  \"%%%%%s;%%%%\" or refid12 like  \"%%%%%s;%%%%\" or refid13 like  \"%%%%%s;%%%%\" or refid14 like  \"%%%%%s;%%%%\" or refid15 like  \"%%%%%s;%%%%\" or refid16 like  \"%%%%%s;%%%%\" or refid17 like  \"%%%%%s;%%%%\" or refid18 like  \"%%%%%s;%%%%\" or refid19 like  \"%%%%%s;%%%%\" or refid20 like  \"%%%%%s;%%%%\" or refid21 like  \"%%%%%s;%%%%\" or refid22 like  \"%%%%%s;%%%%\" or refid23 like  \"%%%%%s;%%%%\" or refid24 like  \"%%%%%s;%%%%\" or refid25 like  \"%%%%%s;%%%%\" or refid26 like  \"%%%%%s;%%%%\" or refid27 like  \"%%%%%s;%%%%\" or refid28 like  \"%%%%%s;%%%%\" or refid29 like  \"%%%%%s;%%%%\" or refid30 like  \"%%%%%s;%%%%\" or refid31 like  \"%%%%%s;%%%%\" or refid32 like  \"%%%%%s;%%%%\" or refid33 like  \"%%%%%s;%%%%\" or refid34 like  \"%%%%%s;%%%%\" or refid35 like  \"%%%%%s;%%%%\" or refid36 like  \"%%%%%s;%%%%\" or refid37 like  \"%%%%%s;%%%%\" or refid38 like  \"%%%%%s;%%%%\" or refid39 like  \"%%%%%s;%%%%\" or refid40 like  \"%%%%%s;%%%%\" or refid41 like  \"%%%%%s;%%%%\" or refid42 like  \"%%%%%s;%%%%\" or refid43 like  \"%%%%%s;%%%%\" or refid44 like  \"%%%%%s;%%%%\" or refid45 like  \"%%%%%s;%%%%\" or refid46 like  \"%%%%%s;%%%%\" or refid47 like  \"%%%%%s;%%%%\" or refid48 like  \"%%%%%s;%%%%\" or refid49 like  \"%%%%%s;%%%%\" or refid50 like  \"%%%%%s;%%%%\"' % (ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID))
...
def rn6IDQuery(uploaded_file):
	...
	with open(resultName, 'w+') as f:
		...
		for pk in range(len(PKs)):
			...
			RES = Rn6.objects.raw('SELECT 1 as id , cgid, chrom, cgistart, cgiend, length, pergc, obsexp,type1, genesym1, strand1, refid1,type2, genesym2, strand2, refid2,type3, genesym3, strand3, refid3,type4, genesym4, strand4, refid4,type5, genesym5, strand5, refid5,type6, genesym6, strand6, refid6,type7, genesym7, strand7, refid7,type8, genesym8, strand8, refid8,type9, genesym9, strand9, refid9,type10, genesym10, strand10, refid10,type11, genesym11, strand11, refid11,type12, genesym12, strand12, refid12,type13, genesym13 , strand13, refid13,type14, genesym14 , strand14, refid14,type15, genesym15 , strand15, refid15,type16, genesym16 , strand16, refid16,type17, genesym17 , strand17, refid17,type18, genesym18 , strand18, refid18,type19, genesym19 , strand19, refid19,type20, genesym20 , strand20, refid20,type21, genesym21 , strand21, refid21,type22, genesym22 , strand22, refid22,type23, genesym23 , strand23, refid23,type24, genesym24 , strand24, refid24,type25, genesym25 , strand25, refid25,type26, genesym26 , strand26, refid26 FROM Rn6 WHERE type1!="Intergenic" and refid1 like  \"%%%%%s;%%%%\" or refid2 like  \"%%%%%s;%%%%\" or refid3 like  \"%%%%%s;%%%%\" or refid4 like  \"%%%%%s;%%%%\" or refid5 like  \"%%%%%s;%%%%\" or refid6 like  \"%%%%%s;%%%%\" or refid7 like  \"%%%%%s;%%%%\" or refid8 like  \"%%%%%s;%%%%\" or refid9 like  \"%%%%%s;%%%%\" or refid10 like  \"%%%%%s;%%%%\" or refid11 like  \"%%%%%s;%%%%\" or refid12 like  \"%%%%%s;%%%%\" or refid13 like  \"%%%%%s;%%%%\" or refid14 like  \"%%%%%s;%%%%\" or refid15 like  \"%%%%%s;%%%%\" or refid16 like  \"%%%%%s;%%%%\" or refid17 like  \"%%%%%s;%%%%\" or refid18 like  \"%%%%%s;%%%%\" or refid19 like  \"%%%%%s;%%%%\" or refid20 like  \"%%%%%s;%%%%\" or refid21 like  \"%%%%%s;%%%%\" or refid22 like  \"%%%%%s;%%%%\" or refid23 like  \"%%%%%s;%%%%\" or refid24 like  \"%%%%%s;%%%%\" or refid25 like  \"%%%%%s;%%%%\" or refid26 like  \"%%%%%s;%%%%\"' % (ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID,ID))
	...
	with open(resultName2, 'w+') as f2:
		...
		for line in LocList:
			...
			if len(L) == 1:
				...
				Q = Hg38.objects.raw('SELECT 1 as id , cgid, chrom, cgistart, cgiend, length, pergc, obsexp,type1, genesym1, strand1, refid1,type2, genesym2, strand2, refid2,type3, genesym3, strand3, refid3,type4, genesym4, strand4, refid4,type5, genesym5, strand5, refid5,type6, genesym6, strand6, refid6,type7, genesym7, strand7, refid7,type8, genesym8, strand8, refid8,type9, genesym9, strand9, refid9,type10, genesym10, strand10, refid10,type11, genesym11, strand11, refid11,type12, genesym12, strand12, refid12,type13, genesym13 , strand13, refid13 FROM Hg38 WHERE chrom = "%s"' % (chr))
				for obj in Q:
					AssoCGI = [obj.cgid, obj.chrom, obj.cgistart, obj.cgiend, obj.pergc, obj.length, obj.obsexp]
					AssoCGI = [str(i) for i in AssoCGI]
					Annot = [[obj.type1, obj.genesym1, obj.strand1, obj.refid1],
			...
			if len(L)>1:	
				...
				Q = Hg38.objects.raw('SELECT 1 as id , cgid, chrom, cgistart, cgiend, length, pergc, obsexp,type1, genesym1, strand1, refid1,type2, genesym2, strand2, refid2,type3, genesym3, strand3, refid3,type4, genesym4, strand4, refid4,type5, genesym5, strand5, refid5,type6, genesym6, strand6, refid6,type7, genesym7, strand7, refid7,type8, genesym8, strand8, refid8,type9, genesym9, strand9, refid9,type10, genesym10, strand10, refid10,type11, genesym11, strand11, refid11,type12, genesym12, strand12, refid12,type13, genesym13 , strand13, refid13 FROM Hg38 WHERE chrom = "%s" and cgistart >= %d AND cgiend <= %d' % (chr, sLoc, eLoc))
				for obj in Q:
					AssoCGI = [obj.cgid, obj.chrom, obj.cgistart, obj.cgiend, obj.pergc, obj.length, obj.obsexp]
					AssoCGI = [str(i) for i in AssoCGI]
					Annot = [[obj.type1, obj.genesym1, obj.strand1, obj.refid1],
	...
	with open(resultName2, 'w+') as f2:
		...
		for line in LocList:
			...
			if len(L)==1:
				...
				Q = Mm10.objects.raw('SELECT 1 as id , cgid, chrom, cgistart, cgiend, length, pergc, obsexp,type1, genesym1, strand1, refid1,type2, genesym2, strand2, refid2,type3, genesym3, strand3, refid3,type4, genesym4, strand4, refid4,type5, genesym5, strand5, refid5,type6, genesym6, strand6, refid6,type7, genesym7, strand7, refid7,type8, genesym8, strand8, refid8,type9, genesym9, strand9, refid9,type10, genesym10, strand10, refid10,type11, genesym11, strand11, refid11,type12, genesym12, strand12, refid12,type13, genesym13 , strand13, refid13,type14, genesym14 , strand14, refid14,type15, genesym15 , strand15, refid15,type16, genesym16 , strand16, refid16,type17, genesym17 , strand17, refid17,type18, genesym18 , strand18, refid18,type19, genesym19 , strand19, refid19,type20, genesym20 , strand20, refid20,type21, genesym21 , strand21, refid21,type22, genesym22 , strand22, refid22,type23, genesym23 , strand23, refid23,type24, genesym24 , strand24, refid24,type25, genesym25 , strand25, refid25,type26, genesym26 , strand26, refid26,type27, genesym27 , strand27, refid27,type28, genesym28 , strand28, refid28,type29, genesym29 , strand29, refid29,type30, genesym30 , strand30, refid30,type31, genesym31 , strand31, refid31,type32, genesym32 , strand32, refid32,type33, genesym33 , strand33, refid33,type34, genesym34 , strand34, refid34,type35, genesym35 , strand35, refid35,type36, genesym36 , strand36, refid36,type37, genesym37 , strand37, refid37,type38, genesym38 , strand38, refid38,type39, genesym39 , strand39, refid39,type40, genesym40 , strand40, refid40,type41, genesym41 , strand41, refid41,type42, genesym42 , strand42, refid42,type43, genesym43 , strand43, refid43,type44, genesym44 , strand44, refid44,type45, genesym45 , strand45, refid45,type46, genesym46 , strand46, refid46,type47, genesym47 , strand47, refid47,type48, genesym48 , strand48, refid48,type49, genesym49 , strand49, refid49,type50, genesym50 , strand50, refid50 FROM Mm10 WHERE chrom = "%s"' % (chr))
				for obj in Q:
					AssoCGI = [obj.cgid, obj.chrom, obj.cgistart, obj.cgiend, obj.pergc, obj.length, obj.obsexp]
					AssoCGI = [str(i) for i in AssoCGI]
					Annot = [[obj.type1, obj.genesym1, obj.strand1, obj.refid1],
			...
			if len(L)>1:
				...
				Q = Mm10.objects.raw('SELECT 1 as id , cgid, chrom, cgistart, cgiend, length, pergc, obsexp,type1, genesym1, strand1, refid1,type2, genesym2, strand2, refid2,type3, genesym3, strand3, refid3,type4, genesym4, strand4, refid4,type5, genesym5, strand5, refid5,type6, genesym6, strand6, refid6,type7, genesym7, strand7, refid7,type8, genesym8, strand8, refid8,type9, genesym9, strand9, refid9,type10, genesym10, strand10, refid10,type11, genesym11, strand11, refid11,type12, genesym12, strand12, refid12,type13, genesym13 , strand13, refid13,type14, genesym14 , strand14, refid14,type15, genesym15 , strand15, refid15,type16, genesym16 , strand16, refid16,type17, genesym17 , strand17, refid17,type18, genesym18 , strand18, refid18,type19, genesym19 , strand19, refid19,type20, genesym20 , strand20, refid20,type21, genesym21 , strand21, refid21,type22, genesym22 , strand22, refid22,type23, genesym23 , strand23, refid23,type24, genesym24 , strand24, refid24,type25, genesym25 , strand25, refid25,type26, genesym26 , strand26, refid26,type27, genesym27 , strand27, refid27,type28, genesym28 , strand28, refid28,type29, genesym29 , strand29, refid29,type30, genesym30 , strand30, refid30,type31, genesym31 , strand31, refid31,type32, genesym32 , strand32, refid32,type33, genesym33 , strand33, refid33,type34, genesym34 , strand34, refid34,type35, genesym35 , strand35, refid35,type36, genesym36 , strand36, refid36,type37, genesym37 , strand37, refid37,type38, genesym38 , strand38, refid38,type39, genesym39 , strand39, refid39,type40, genesym40 , strand40, refid40,type41, genesym41 , strand41, refid41,type42, genesym42 , strand42, refid42,type43, genesym43 , strand43, refid43,type44, genesym44 , strand44, refid44,type45, genesym45 , strand45, refid45,type46, genesym46 , strand46, refid46,type47, genesym47 , strand47, refid47,type48, genesym48 , strand48, refid48,type49, genesym49 , strand49, refid49,type50, genesym50 , strand50, refid50 FROM Mm10 WHERE chrom = "%s" and cgistart >= %d AND cgiend <= %d' % (chr, sLoc, eLoc))
				for obj in Q:
					AssoCGI = [obj.cgid, obj.chrom, obj.cgistart, obj.cgiend, obj.pergc, obj.length, obj.obsexp]
					AssoCGI = [str(i) for i in AssoCGI]
					Annot = [[obj.type1, obj.genesym1, obj.strand1, obj.refid1],
	...
	with open(resultName2, 'w+') as f2:
		...
		for line in LocList:
			...
			if len(L)==1:
				...
				Q = Dm3.objects.raw('SELECT 1 as id , cgid, chrom, cgistart, cgiend, length, pergc, obsexp,type1, genesym1, strand1, refid1,type2, genesym2, strand2, refid2,type3, genesym3, strand3, refid3,type4, genesym4, strand4, refid4,type5, genesym5, strand5, refid5,type6, genesym6, strand6, refid6,type7, genesym7, strand7, refid7,type8, genesym8, strand8, refid8,type9, genesym9, strand9, refid9,type10, genesym10, strand10, refid10,type11, genesym11, strand11, refid11,type12, genesym12, strand12, refid12,type13, genesym13 , strand13, refid13,type14, genesym14 , strand14, refid14,type15, genesym15 , strand15, refid15,type16, genesym16 , strand16, refid16,type17, genesym17 , strand17, refid17,type18, genesym18 , strand18, refid18,type19, genesym19 , strand19, refid19,type20, genesym20 , strand20, refid20,type21, genesym21 , strand21, refid21,type22, genesym22 , strand22, refid22,type23, genesym23 , strand23, refid23,type24, genesym24 , strand24, refid24,type25, genesym25 , strand25, refid25,type26, genesym26 , strand26, refid26,type27, genesym27 , strand27, refid27,type28, genesym28 , strand28, refid28,type29, genesym29 , strand29, refid29,type30, genesym30 , strand30, refid30,type31, genesym31 , strand31, refid31,type32, genesym32 , strand32, refid32,type33, genesym33 , strand33, refid33,type34, genesym34 , strand34, refid34,type35, genesym35 , strand35, refid35,type36, genesym36 , strand36, refid36,type37, genesym37 , strand37, refid37,type38, genesym38 , strand38, refid38,type39, genesym39 , strand39, refid39,type40, genesym40 , strand40, refid40,type41, genesym41 , strand41, refid41,type42, genesym42 , strand42, refid42,type43, genesym43 , strand43, refid43,type44, genesym44 , strand44, refid44,type45, genesym45 , strand45, refid45,type46, genesym46 , strand46, refid46,type47, genesym47 , strand47, refid47,type48, genesym48 , strand48, refid48,type49, genesym49 , strand49, refid49,type50, genesym50 , strand50, refid50 FROM Dm3 WHERE chrom = "%s" and cgistart >= %d AND cgiend <= %d' % (chr, sLoc, eLoc))
				for obj in Q:
					AssoCGI = [obj.cgid, obj.chrom, obj.cgistart, obj.cgiend, obj.pergc, obj.length, obj.obsexp]
					AssoCGI = [str(i) for i in AssoCGI]
					Annot = [[obj.type1, obj.genesym1, obj.strand1, obj.refid1],
	...
	with open(resultName2, 'w+') as f2:
		...
		for line in LocList:
			...
			if len(L)==1:
				...
				Q = Ce10.objects.raw('SELECT 1 as id , cgid, chrom, cgistart, cgiend, length, pergc, obsexp,type1, genesym1, strand1, refid1,type2, genesym2, strand2, refid2,type3, genesym3, strand3, refid3,type4, genesym4, strand4, refid4,type5, genesym5, strand5, refid5,type6, genesym6, strand6, refid6,type7, genesym7, strand7, refid7,type8, genesym8, strand8, refid8,type9, genesym9, strand9, refid9,type10, genesym10, strand10, refid10,type11, genesym11, strand11, refid11,type12, genesym12, strand12, refid12,type13, genesym13 , strand13, refid13,type14, genesym14 , strand14, refid14,type15, genesym15 , strand15, refid15,type16, genesym16 , strand16, refid16,type17, genesym17 , strand17, refid17,type18, genesym18 , strand18, refid18,type19, genesym19 , strand19, refid19,type20, genesym20 , strand20, refid20,type21, genesym21 , strand21, refid21,type22, genesym22 , strand22, refid22,type23, genesym23 , strand23, refid23,type24, genesym24 , strand24, refid24,type25, genesym25 , strand25, refid25,type26, genesym26 , strand26, refid26 FROM Ce10 WHERE chrom = "%s" and cgistart >= %d AND cgiend <= %d' % (chr, sLoc, eLoc))
				for obj in Q:
					AssoCGI = [obj.cgid, obj.chrom, obj.cgistart, obj.cgiend, obj.pergc, obj.length, obj.obsexp]
					AssoCGI = [str(i) for i in AssoCGI]
					Annot = [[obj.type1, obj.genesym1, obj.strand1, obj.refid1],
	...
	with open(resultName2, 'w+') as f2:
		...
		for line in LocList:
			...
			if len(L)==1:
				...
				Q = Rn6.objects.raw('SELECT 1 as id , cgid, chrom, cgistart, cgiend, length, pergc, obsexp,type1, genesym1, strand1, refid1,type2, genesym2, strand2, refid2,type3, genesym3, strand3, refid3,type4, genesym4, strand4, refid4,type5, genesym5, strand5, refid5,type6, genesym6, strand6, refid6,type7, genesym7, strand7, refid7,type8, genesym8, strand8, refid8,type9, genesym9, strand9, refid9,type10, genesym10, strand10, refid10,type11, genesym11, strand11, refid11,type12, genesym12, strand12, refid12,type13, genesym13 , strand13, refid13,type14, genesym14 , strand14, refid14,type15, genesym15 , strand15, refid15,type16, genesym16 , strand16, refid16,type17, genesym17 , strand17, refid17,type18, genesym18 , strand18, refid18,type19, genesym19 , strand19, refid19,type20, genesym20 , strand20, refid20,type21, genesym21 , strand21, refid21,type22, genesym22 , strand22, refid22,type23, genesym23 , strand23, refid23,type24, genesym24 , strand24, refid24,type25, genesym25 , strand25, refid25,type26, genesym26 , strand26, refid26 FROM Rn6 WHERE chrom = "%s" and cgistart >= %d AND cgiend <= %d' % (chr, sLoc, eLoc))
				for obj in Q:
					AssoCGI = [obj.cgid, obj.chrom, obj.cgistart, obj.cgiend, obj.pergc, obj.length, obj.obsexp]
					AssoCGI = [str(i) for i in AssoCGI]
					Annot = [[obj.type1, obj.genesym1, obj.strand1, obj.refid1],
